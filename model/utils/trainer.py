...
class EvaluateFriendlySeq2SeqTrainer(transformers.trainer_seq2seq.Seq2SeqTrainer):
    ...
    def evaluate(
        ...
        ### TODOs: Modify the hard code here
        self._min_length = 20
        # self._max_length = 140
        self._no_repeat_gram = 3
        self._length_penalty = self.args.generation_length_penalty
    ...
    def prediction_step(
        ...
        gen_kwargs = {
            ...
            "no_repeat_ngram_size": self._no_repeat_gram,
            "max_length": self._max_length,
            "min_length": self._min_length,
            "num_beams": self._num_beams,
            "length_penalty": self._length_penalty, # FIXME: hard coding the no_repeat_ngram_size
        }
