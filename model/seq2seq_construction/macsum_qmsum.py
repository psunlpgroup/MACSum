...
class Constructor(object):
    ...
    def to_seq2seq(self, raw_datasets: DatasetDict, cache_root: str):
        train_dataset = MACQMSUMDataset(self.args, raw_datasets['train'])
        test_dataset = MACQMSUMDataset(self.args, raw_datasets['test'])
        dev_dataset = MACQMSUMDataset(self.args, raw_datasets['validation'])
        return train_dataset, dev_dataset, test_dataset

class MACQMSUMDataset(Dataset):
    ...
    def __init__(self, args, raw_datasets):
        ...
        for raw_data in raw_datasets:
            ...
            raw_data.update({"text_in": raw_data['article'],
                             ...
                             "speaker": raw_data['speaker'], # difference between CNNDM
